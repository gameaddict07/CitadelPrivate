...
/obj/item/clothing/suit/armor/vest/capcarapace/cent
	name = "overseer's jacket"
	desc = "A heavily armored jacket for centcom overseers, so you can look good while you get robusted. Protects you from space using micro forcefield generators.."
