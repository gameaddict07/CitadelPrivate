...
/obj/item/clothing/head/helmet/space/beret/centcom
	name = "overseer's beret"
	desc = "An armored beret commonly used by special operations officers, but this one has been repurposed for use by an overseer. Uses advanced force field technology to protect the head from space, aswell as function as a breathing aparatus."
	icon_state = "beret_badge_green"
	flags = STOPSPRESSUREDMAGE | BLOCK_GAS_SMOKE_EFFECT | MASKINTERNALS
