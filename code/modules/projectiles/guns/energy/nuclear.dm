...
/obj/item/weapon/gun/energy/gun/centoverseer
	name = "\improper X-02 MultiPhase Pulse Pistol"
	desc = "This is an advanced pulse weapon, modeled after an antique laser gun. This gun has several unique firemodes, and has been upgraded with an advanced cell for practically unlimited shots."
	icon_state = "hoslaser"
	force = 10
	pin = /obj/item/device/firing_pin/implant/loyalty
	ammo_type = list(/obj/item/ammo_casing/energy/electrode/hos, /obj/item/ammo_casing/energy/laser/hos, /obj/item/ammo_casing/energy/disabler, /obj/item/ammo_casing/energy/laser/pulse)
	ammo_x_offset = 4
