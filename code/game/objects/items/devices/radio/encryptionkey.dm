...
/obj/item/device/encryptionkey/master
	name = "master encryption key"
	desc = "A master encryption key for a radio headset. Channels are as follows: Channels are as follows: :y - centcom :c - command, :s - security, :e - engineering, :u - supply, :v - service, :m - medical, :n - science."
	icon_state = "cent_cypherkey"
	centcom = 1
