...
/obj/item/device/radio/headset/headset_cent/overseer
	name = "\improper Centcom bowman headset"
	desc = "The headset of a centcom overseer. Protects ears from flashbangs. \nChannels are as follows: :y - centcom :c - command, :s - security, :e - engineering, :u - supply, :v - service, :m - medical, :n - science."
	flags = EARBANGPROTECT
	icon_state = "cent_headset_alt"
	item_state = "cent_headset_alt"
	keyslot = new /obj/item/device/encryptionkey/master
