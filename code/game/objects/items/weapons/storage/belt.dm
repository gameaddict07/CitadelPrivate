...
/obj/item/weapon/storage/belt/holster/bluespace
	name = "bluespace webbing"
	desc = "Utility webbing modified with bluespace technology to carry a ridiculous amount of gear. How aren't you pulling your back out?"
	icon_state = "holster"
	item_state = "holster"
	storage_slots = 28
	max_w_class = 5
	w_class = 4
	max_combined_w_class = 500
